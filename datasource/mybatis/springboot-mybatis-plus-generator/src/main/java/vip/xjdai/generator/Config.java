...
public class Config
{
     ...
     * 当前项目路径
     */
    private static final String path = Thread.currentThread().getContextClassLoader().getResource(
    ...
    public static PackageConfig createPackageConfig()
    {
        ...
        pc.setController("controller");//生成的pack名称为 ， vip.xjdai.controller
        pc.setService("service");//生成的pack名称为 ， vip.xjdai.service
        pc.setServiceImpl("service.impl");//生成的pack名称为 ， vip.xjdai.service.impl
        pc.setEntity("domain");//生成的pack名称为 ， vip.xjdai.domain
        pc.setMapper("mapper");//生成的pack名称为 ， vip.xjdai.mapper
        return pc;
    }
