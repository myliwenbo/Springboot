...
import vip.xjdai.qikuairong.config.TemplateConfigEnhance;
import vip.xjdai.qikuairong.templates.*;
...
//    private static final String PASSWORD = "N^xHa#fG&2U4FPod";
    ...
    public static void createInjectionConfig(AutoGenerator mpg) {
        ...
        templatesList.contextMethod(new DTOEntityTemplates());
