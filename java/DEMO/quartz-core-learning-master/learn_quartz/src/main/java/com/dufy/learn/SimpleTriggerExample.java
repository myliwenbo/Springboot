...
public class SimpleTriggerExample {
    static Logger log = LoggerFactory
            .getLogger(SimpleTriggerExample.class);
     ...
     * @throws Exception
     */
    public void register(String jobName, String jobGroup, String triggerName,
                         String triggerGroup, long afterTime) throws Exception {
        ...
        JobDetail job = newJob(HelloSimpleJob.class).withIdentity(jobName, jobGroup)
                .build();
        ...
        Trigger trigger = newTrigger().withIdentity(triggerName, triggerGroup)
                .withSchedule(SimpleScheduleBuilder.simpleSchedule()).startAt(runTime)
                .build();
